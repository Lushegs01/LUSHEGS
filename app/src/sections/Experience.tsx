  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      organization: 'ScanMark.',
      location: 'Lagos, Nigeria',
      period: '2024 - Present',
      description: 'Leading development of enterprise-scale web application.',
      highlights: [
        'Architected microservices infrastructure serving 6K+ users',
        'Reduced application load time by 60% through optimization',
        'Led a team of 2 developers across the project',
      ],
    },
    {
      type: 'work',
      ...
      location: 'Lagos, Nigeria',
      period: '2024 - Present',
      description: 'Developed custom web solutions for fitness trainers with focus on performance and UX.',
      highlights: [
        'Delivered optimized PWAs for fitness trainers',
    ...
    },
    {
      ...
      location: 'Abeokuta, Nigeria',
      period: '2024 - 2028',
      description: 'Focused on software engineering, Data Structure & Algorithms, and web technologies.',
      highlights: [
        'GPA: 4.6/5.0',
        'COLCOMPS\'s Tech Guru Of The Year',
        'Software Dev: All time',
      ],
    },
    {
      type: 'award',
      title: 'Tech Guru Of the Year Award',
      organization: 'FUNAAB 2026',
      location: 'FUNAAB',
      period: '2026',
      description: 'Recognized for outstanding development of Problem-Solving tech.',
      highlights: [
        'Top contributor to Git ecosystem',
        'Created popular web apps',
      ],
    },
  ];
