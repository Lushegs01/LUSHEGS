  ...
  const projects: Project[] = [
    {
      id: 1,
      title: 'ScanMark',
      description: 'ScanMark is an enterprise-grade, offline-first digital attendance platform for universities that uses 5-second cryptographic QR codes and GPS geofencing to instantly verify student presence and completely eliminate proxy cheating.',
      image: '/project-ecommerce.jpg',
      tags: ['Redis', 'Node.js', 'JS', 'PostgreSQL'],
      category: 'Ed-Tech',
      liveUrl: 'https://scanmark.vercel.app',
      githubUrl: 'https://github.com/Lushegs01/scanmark',
    },
    {
      id: 2,
      title: 'FunaaBnB',
      description: 'FunaaBnB is a secure, scam-free student housing marketplace exclusively designed to connect FUNAAB students with verified off-campus apartments.',
      image: '/project-saas.jpg',
      tags: ['Next.js', 'TypeScript', 'MongoDB', 'node.js'],
      category: 'SaaS',
      liveUrl: 'https://funaabnb.vercel.app',
      githubUrl: 'https://github.com/Lushegs01/funaabnb-frontend',
    },
    {
      id: 3,
      title: 'Session Tracker(MAXFIT)',
      ...
      tags: ['React Native', 'Redis', 'HTML', 'HealthKit'],
      category: 'Mobile',
      liveUrl: '#',
      githubUrl: '#',
    },
    {
      id: 4,
      title: 'ScanMark Organisations',
      description: 'QR-code attendance tracking for corporate teams and event organisers; replace paper registers with instant check-ins, live dashboards, and compliance reports.',
      image: '/project-portfolio.jpg',
      tags: ['GSAP', 'Three.js', 'WebGL', 'node.js'],
      category: 'Web',
      liveUrl: 'https://scanmark-organisations.onrender.com',
      githubUrl: 'https://github.com/Lushegs01/ScanMark-Organisations',
    },
  ];
